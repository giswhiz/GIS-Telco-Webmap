...
L.Control.GroupedLayers = L.Control.extend({
  ...
  initialize: function (baseLayers, groupedOverlays, options) {
    ...
    for (i in groupedOverlays) {
      for (j in groupedOverlays[i]) {
        this._addLayer(groupedOverlays[i][j], j, i, true, false);
      }
    }
  },
  ...
  addOverlay: function (layer, name, group,checkbox_grp) {
    this._addLayer(layer, name, group, true,checkbox_grp);
    this._update();
    return this;
  },
  ...
  _addLayer: function (layer, name, group, overlay,checkbox_grp=false) {
    var id = L.Util.stamp(layer);
  ...
  _expand: function () {
    ...
    var acceptableHeight = this._map.getSize().y - (this._container.offsetTop * 4);
